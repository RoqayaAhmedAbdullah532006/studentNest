...
<div class="container">
 ...
 <div class="property-gallery">
    <div class="main-image">
        <img
            id="mainImage"
            src="/studentNest/assest/images/<?= htmlspecialchars($images[0]['image']) ?>"
            alt="Property">
    </div>
    ...
    <div class="gallery-images">
        <?php foreach($images as $img): ?>
            <img
                src="/studentNest/assest/images/<?= htmlspecialchars($img['image']) ?>"
    ...
    <div class="property-content">
        ...
        <div class="owner-card">
            ...
            <img src="../assets/images/avatar.png" alt="Owner">
    ...
    <div class="card-buttons">
        ...
        <!-- تم إضافة الكلاس هنا ليكون بنفس شكل باقي الأزرار -->
