...
<div class="section-title" style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <!-- زر إظهار كل العقارات يظهر فقط إذا كان المستخدم مفلتر حسب فئة -->
    <?php if ($categoryId > 0): ?>
...
<?php if(!empty($property['image'])): ?>
    <!-- عرض الصورة من مجلد images مباشرة -->
    <img src="../assest/images/<?= htmlspecialchars($property['image']) ?>" alt="<?= htmlspecialchars($property['title']) ?>">
<?php else: ?>
    <!-- صورة افتراضية في حال لم تتوفر صورة -->
    <img src="../assets/imges/8.jpeg" alt="Property">
<?php endif; ?>
